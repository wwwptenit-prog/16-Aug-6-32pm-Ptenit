  ...
  return (
    ...
    >
      ...
      <div className="p-2 sm:p-3.5 md:p-4 border-t border-slate-100 dark:border-slate-800/80 flex items-center justify-between gap-1 bg-slate-50/70 dark:bg-slate-950/40 rounded-b-2xl sm:rounded-b-3xl">
        <div>
          <span className="text-[9px] sm:text-xs text-slate-400 dark:text-slate-400 font-bold block uppercase tracking-wider">
            শুরু মাত্র
          </span>
          <div className="flex items-baseline gap-0.5 sm:gap-1">
            <span className="text-xs sm:text-lg font-black text-[#1DB954]">
        ...
        <button
          ...
          className="px-2.5 py-1 sm:px-4 sm:py-2 rounded-lg sm:rounded-xl bg-[#1DB954] hover:bg-emerald-600 text-white font-bold font-bengali text-[10px] sm:text-sm shadow-xs sm:shadow-md sm:shadow-[#1DB954]/20 transition-all cursor-pointer flex items-center gap-0.5 sm:gap-1"
        >
          <span>বিস্তারিত</span>
        </button>
      </div>
