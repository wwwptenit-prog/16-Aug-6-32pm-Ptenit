...
export const ServicesSection: React.FC<ServicesSectionProps> = ({
  ...
  const featuredGigs = gigs.slice(0, 5);
        ...
        <div className="max-w-[1920px] mx-auto space-y-8 sm:space-y-12">
          ...
          <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4 border-b border-slate-200 dark:border-slate-800 pb-5">
            ...
            <div className="flex items-center gap-2 shrink-0">
              <span className="px-3 py-1.5 bg-[#1DB954]/10 text-[#1DB954] border border-[#1DB954]/20 rounded-full text-xs font-bold">
                {allPublishedServices.length} টি প্রস্তুত সার্ভিস
              </span>
            </div>
          </div>

          {/* Full Grid of Agency Services - 5 Cols PC, 2 Cols Phone (using GigCard) */}
  ...
  // HOME PAGE SECTION VIEW - Show maximum 5 official agency packages (1 row of 5 on PC)
  const visibleAgencyServices = allPublishedServices.slice(0, 5);
    ...
    <section className="py-8 sm:py-12 bg-slate-50 dark:bg-slate-900/80">
      <div className="max-w-[1920px] mx-auto px-3 sm:px-8 md:px-12 lg:px-16 xl:px-20 space-y-10 sm:space-y-12">
        ...
        <div className="space-y-6 sm:space-y-8">
          ...
          {/* Agency Services Grid: Desktop shows 5; Mobile shows max 4 unless expanded */}
          <div>
            {/* Desktop (Hidden on mobile): 1 row of 5 */}
        ...
        <div className="space-y-6 pt-8 border-t border-slate-200 dark:border-slate-800">
          ...
          {/* Gigs Grid: Desktop shows 5; Mobile shows max 4 unless expanded */}
          <div>
            {/* Desktop (Hidden on mobile): 1 row of 5 */}
            <div className="hidden sm:grid sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-5 xl:grid-cols-5 gap-4 lg:gap-5">
